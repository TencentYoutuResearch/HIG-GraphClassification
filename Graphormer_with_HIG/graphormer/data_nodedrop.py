...
from collator_nodedrop import collator
from wrapper_nodedrop import MyGraphPropPredDataset, MyPygPCQM4MDataset, MyPygPCQM4Mv2Dataset, MyZINCDataset
...
def get_dataset(dataset_name='abaaba'):
    ...
    if dataset_name == 'ogbg-molpcba':
        ...
        dataset = {
            ...
            'dataset': MyPygPCQM4Mv2Dataset(root='../../dataset'),
            'max_node': 128,
        }
...
class GraphDataModule(LightningDataModule):
    ...
    def setup(self, stage: str = None):
        if self.dataset_name == 'ZINC':
            ...
            if self.dataset_name == 'PCQM4Mv2':
                self.dataset_test = self.dataset['dataset'][split_idx["test-dev"]]
            else:
