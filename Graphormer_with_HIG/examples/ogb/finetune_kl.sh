...
[ -z "${exp_name}" ] && exp_name="pcba_flag_ft_kl"
[ -z "${seed}" ] && seed="1"
...
[ -z "${ckpt_path}" ] && ckpt_path="../../exps/tmp/ogbg-molpcba-epoch=008-valid_ap=0.3455.ckpt"
...
python ../../graphormer/entry_kl.py --num_workers 8 --seed $seed --batch_size $batch_size \
...
do
      ...
      echo "$file"
      echo -e "\n\n\n"
      python ../../graphormer/entry_kl.py --num_workers 8 --seed 1 --batch_size $batch_size \
            --dataset_name ogbg-molpcba \
